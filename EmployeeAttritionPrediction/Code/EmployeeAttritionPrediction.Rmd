...
A rigorous approach is to manage model in a data base. For simplicity purpose,
in this tutorial, the model is preserved on Azure Storage Account as a [blob](https://azure.microsoft.com/en-us/services/storage/blobs/). Blob storage
does not restrict file format and it allows easy management on access control.
...
devtools::install_url("https://github.com/yueguoguo/Azure-R-Interface/raw/master/utils/msLanguageR_0.1.0.tar.gz")
