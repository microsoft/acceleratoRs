...
source("../../sent_analytis/scripts/R/confidential.R")
```

```{r, eval=FALSE}
text <- "我非常喜欢现在的工作"
translated_text1 <- cognitiveTranslation(text, lanFrom="zh-CHS", lanTo="en", apiKey=KEY_TRANS)
...
```{r}
senti_score <- cognitiveSentiAnalysis(text=df[-train_index, ]$Feedback, apiKey=KEY_SENTI)
